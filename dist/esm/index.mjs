    ...
    get value() {
        ...
        for (const enums of __enums__) {
            if (enums.value == this.#value) {
                const property = { value: enums.id }, value = _nuka9510_js_util__WEBPACK_IMPORTED_MODULE_0__.Util.copy(this.#value);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Enum: () => (/* reexport safe */ _enum_js__WEBPACK_IMPORTED_MODULE_0__["default"])
/* harmony export */ });
/* harmony import */ var _enum_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./enum.js */ "./dist/enum.js");
...
export { __webpack_exports__Enum as Enum };
